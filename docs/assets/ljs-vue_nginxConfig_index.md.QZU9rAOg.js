import{_ as n,c as s,o as a,a5 as p}from"./chunks/framework.D2w-0S4J.js";const x=JSON.parse('{"title":"Nginx配置","description":"","frontmatter":{},"headers":[],"relativePath":"ljs-vue/nginxConfig/index.md","filePath":"ljs-vue/nginxConfig/index.md"}'),e={name:"ljs-vue/nginxConfig/index.md"},l=p(`<h1 id="nginx配置" tabindex="-1">Nginx配置 <a class="header-anchor" href="#nginx配置" aria-label="Permalink to &quot;Nginx配置&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>worker_processes  1;</span></span>
