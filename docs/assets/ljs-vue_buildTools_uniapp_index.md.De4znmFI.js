import{_ as s,c as a,o as n,aj as p}from"./chunks/framework.CKd5D8ET.js";const _=JSON.parse('{"title":"ljs-uniapp","description":"","frontmatter":{},"headers":[],"relativePath":"ljs-vue/buildTools/uniapp/index.md","filePath":"ljs-vue/buildTools/uniapp/index.md"}'),e={name:"ljs-vue/buildTools/uniapp/index.md"},l=p(`<h1 id="ljs-uniapp" tabindex="-1">ljs-uniapp <a class="header-anchor" href="#ljs-uniapp" aria-label="Permalink to &quot;ljs-uniapp&quot;">​</a></h1><p>Uniapp+Vue2构建的移动端的框架（可快速开发：安卓，移动端H5，微信小程序）。</p><h2 id="项目结构" tabindex="-1">项目结构 <a class="header-anchor" href="#项目结构" aria-label="Permalink to &quot;项目结构&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>├── assets                     // 静态资源（样式文件，字体文件等）</span></span>
