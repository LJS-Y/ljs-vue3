 ...
 * @example this.$ljsPublic.base.getUrlParameter('moduleName');
 */
 ...
 * @example const parents = this.$ljsPublic.base.getTreeParents(data, value, key);
 */
 ...
 * @example this.$ljsPublic.base.editTreeParentIdCheck(data, [{value: 32, key: 'id'}, {value: 3, key: 'level'}]);
 * @example this.$ljsPublic.base.editTreeParentIdCheck(data);
 */
...
/**
 * 根节点字体大小计算
 * @example this.$ljsPublic.base.setRemUnit(); 返回结果根节点的font-size大小。
 */
 ...
 * @example this.$ljsPublic.base.selectDictLabel(data, '1')
 */
 ...
 */
export function colorLog(content = ['暂无内容'], type = 'info', color = [
 ...
 * @example this.$ljsPublic.base.downloadImage(this, scope.row.quickResponseCode, `${scope.row.itemName}-${scope.row.typeName}-${scope.row.itemNo}`);
 */
 ...
 * @example this.$ljsPublic.base.fieldCheck(this.aaaa)
 */
 ...
 * @example this.$ljsPublic.base.fieldClean(obj, 'name')
 */
 ...
 * @example const base64Str = await this.$ljsPublic.base.imageFileToBase64(fileFlow);
 */
 ...
 * @example this.$ljsPublic.base.getWindowRatio();
 */
 ...
 * @example this.$ljsPublic.base.deepCopy();
 */
 ...
 * @returns {Any} 处理后的数据。
 * @example this.$ljsPublic.base.apiDateChange(res);
 */
 ...
 * 获取系统信息
 * @returns {Any} 处理后的数据。
 * @example this.$ljsPublic.base.getWindowInfo();
 */
 ...
 * 获取顶部状态栏高度
 * @returns {Any} 处理后的数据。
 * @example this.$ljsPublic.base.getTopStateHeight();
 */
 ...
 * 获取微信 APP 基础信息
 * @returns {Any} 处理后的数据。
 * @example this.$ljsPublic.base.getAppBaseInfo();
 */
