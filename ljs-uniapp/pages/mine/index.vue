<template>
	<view class="comFrame">
		...
		<!-- 修改密码 -->
		<ljs-dialog :title="editPassword_tc.title" v-model="editPassword_tc.open" class="comTc">
			<view class="comForm">
				<view class="one">
		...
		<!-- 修改头像 -->
		<ljs-dialog :title="editHeadpic_tc.title" v-model="editHeadpic_tc.open" class="comTc">
			<view class="comForm">
				<view class="one">
