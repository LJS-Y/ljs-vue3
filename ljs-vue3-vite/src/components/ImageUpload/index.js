...
export default {
  props: {
    ...
    uploadUrl: {
      type: String,
      default: import.meta.env.VITE_APP_API_URL + '/common/upload'
    },
  ...
  data() {
    return {
      ...
      // uploadImgUrl: import.meta.env.VITE_APP_API_URL + "/common/upload", // 上传的图片服务器地址
      headers: {
  ...
  methods: {
    ...
    handleBeforeUpload(file) {
      ...
      if (this.fileSize) {
        ...
        if (!isLt) {
          this.$modal.msgError(`上传图片“${fileName}”的大小不能超过 ${this.fileSize} MB!`);
          this.$modal.closeLoading();
          return false;
        }
      }
