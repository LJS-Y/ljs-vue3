...
// import BrotliPlugin from 'brotli-webpack-plugin'; // br压缩，没有gz压缩的比例高，暂时停用
    ...
    tools: {
      rspack: {
        plugins: [
          ...
          // 配置 Brotli 压缩（压缩率比 Gzip 高 20%-30%）
          // new BrotliPlugin({
          //   test: /\.(js|css|svg|ttf|woff|woff2|eot|otf)$/,
          //   threshold: 1024,
          //   minRatio: 0.8,
          //   filename: '[path][base].br', // 输出格式：xxx.ttf.br
          //   compressionOptions: { level: 11 }, // Brotli 最高压缩级别
          // }),
        ],
      },
    },
