    ...
    <div class="left">
      <el-scrollbar>
        <div
          class="module"
          :class="{
            active: baseData.id === item.id
          }"
          v-for="(item, i) in baseData.module" :key="i"
          @click="moduleC(item)">
        ...
        <div class="comPage">
          ...
          <el-table class="comTable" v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" width="230">
              <template #default="scope">
                <template v-if="$comB.builtInRoles(scope.row.roleKey)">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="角色顺序" prop="roleSort">
          <el-input v-model="form.roleSort" @input="$LJSfc.numCheck(form, 'roleSort')" maxlength="5" placeholder="请输入角色顺序"></el-input>
        </el-form-item>
