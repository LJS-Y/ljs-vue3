import { listRole, getRole, delRole, addRole, updateRole, dataScope, changeRoleStatus, deptTreeSelect, allocatedUserList, authUserCancel, authUserCancelAll } from '@/api/systemManage/system/role';
import { treeselect as menuTreeselect, roleMenuTreeselect } from '@/api/systemManage/system/menu';
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listRole(this.addDateRange(query, this.dateRange)).then(res => {
        if (res.code === 200) {
