  ...
  <div class="childPage">
    ...
    <div class="comPage">
      ...
      <el-row :gutter="10" class="comOperate">
        ...
        <el-col :span="1.5" v-hasPermi="['system:dict:edit']">
          <el-button
            type="success"
            :disabled="single"
            @click="handleUpdate"
          ><el-icon class="el-icon--left"><EditPen /></el-icon>修改</el-button>
        </el-col>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="显示排序" prop="dictSort">
          <el-input v-model="form.dictSort" @input="$LJSfc.numCheck(form, 'dictSort')" maxlength="5" placeholder="请输入显示排序"></el-input>
        </el-form-item>
