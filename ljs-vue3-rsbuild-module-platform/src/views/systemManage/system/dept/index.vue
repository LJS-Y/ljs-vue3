    ...
    <el-dialog :title="title" v-model="open" width="50%" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="组织机构名称" prop="deptName">
              <el-input v-model="form.deptName" maxlength="100" placeholder="请输入组织机构名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="显示排序" prop="orderNum">
              <el-input v-model="form.orderNum" @input="$LJSfc.numCheck(form, 'orderNum')" maxlength="5" placeholder="请输入显示排序"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
