 ...
 *  @example this.$LJSfc.numCheck(obj, 'goodsPrice')
 * */
 ...
 *  @example this.$LJSfc.numEnCheck(obj, 'username')
 * */
 ...
 * @example this.$LJSfc.downloadBlobData(res.data, "房屋价格")，请求需要添加 responseType: "blob"
 * */
