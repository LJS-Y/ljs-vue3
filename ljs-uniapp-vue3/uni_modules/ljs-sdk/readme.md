...
export default {
	...
	tokenExpireCodes: [401, 403], // token失效code。不配置默认判断401。
	technical_support,
}
...
uploadFile(url, name, filePath, timeout: Number = 10000) | Function | 
uploadFiles(url, name, files, params, timeout: Number = 10000) | Function | 
